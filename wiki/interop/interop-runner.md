...
The runner's most recent published cut is the **[2026-07-20 00:34:36 UTC report](https://englishm.github.io/moq-interop-runner/results/2026-07-20_003436/report.html): 338 cells; 134 pass / 204 fail / 0 skip** (~39.6% pass). The matrix **grew +19 to 338** (from 319) as additional draft-18 endpoints were wired into the runner — new rows/columns include `moq-go`, `moq5`, and `xquic-draft-18` — and because **every one of the 19 new cells failed on its first cut**, pass held **flat at 134** while fail absorbed the entire +19 (185 → 204) and **at-target draft-18 rose +19 (171 → 190)** (the first at-target move since it froze at 171 on July 14). None of the July-19/20 Vienna Hackathon merges (imquic draft-19, moqtail's control-plane sprint, moq-rs's SUBSCRIBE_NAMESPACE) show yet — the cut ran at 00:34 UTC before the daytime work, and the live interop is being exercised **manually** on the floor (see Live interop below). No July-21 cut at check time.

A July-7 structural expansion grew the matrix +25 cells to 319 and cleared all 34 skips to zero (every cell now runs); pass then climbed for three straight cuts as the newly-added cross-version cells converted green — +14 (93 → 107) July-8, +17 (107 → 124) July-9, +8 (124 → 132) July-10 — then **oscillated 130↔132** for a week on a byte-for-byte identical matrix: −2 (132 → 130) July-11, +2 (130 → 132) July-12, flat 132 July-13, −2 (132 → 130) July-14, flat 130 July-15 — before **breaking upward to 136** July-16 (+6), edging to **137** July-17 (+1), slipping back to **132** July-18 (−5), recovering **+2 to 134** July-19, and holding **flat at 134** July-20 as a **second structural expansion (+19 to 338)** wired in fresh draft-18 endpoints that all failed on their first cut. Read across the run (107 → 124 → 132 → 130 → 132 → 132 → 130 → 130 → 136 → 137 → 132 → 134 → 134) the July-8–10 hardening phase gave way to a settled band, the July-16/17 uptick did not hold, and at-target held at 171 through July-19 (then +19 to 190 July-20 as new endpoints registered) — so the passing set has not grown; the July-20 fail jump is purely the newly-added, not-yet-converging cells. This followed the July-2 expansion (matrix +28 to 294; at-target draft-18 78 → 152) and five straight cuts holding at-target 152 through the draft-18-only era (July 2–6). The runner still targets **draft-18** and has not advanced to draft-19.
