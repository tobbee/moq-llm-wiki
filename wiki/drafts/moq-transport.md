...
- **IANA early review of draft-19 (2026-07-16)**: IANA (Amanda Baber, ticket #1456083) reviewed the draft ahead of IETF 126 and returned a pre-Last-Call punch-list — the IANA Considerations section is incomplete; the new registries need a named group ("Media over QUIC Transport"), RFC 8126 designated-expert guidance, protocol-differentiated names, and explicit numeric bounds; and the allocations must be reconciled against **inconsistent/duplicate registry values requested by [[moq-loc|loc]], [[moq-secure-objects|secure-objects]], and [[moq-msf|msf]]**. Tracked in [issue #1814](https://github.com/moq-wg/moq-transport/issues/1814) (afrind); the msf side is [msf #191](https://github.com/moq-wg/msf/issues/191) (Will Law). Reframes the "Path to WGLC" work as enumerated registry/IANA items rather than open protocol design.
...
- **SSTS (Sender-Side Track Switching)**: the "Algorithm Zero + IANA registry" extension design (PR #1638), meant to be validated by more than one algorithm before draft-19. See [[switch-abr]].
- **Range filters**: re-adding location-based subscription filters ([[mo-zanaty|Mo Zanaty]]'s PR #1765).
