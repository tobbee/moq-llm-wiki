...
- **IANA early review + registry cleanup (2026-07-16/17).** IANA's Amanda Baber filed an early review of msf-01 ([IANA #1456080], part of a coordinated five-document sweep across the MoQ set — see [[moq-transport]]): §14.2 is missing a registry-group name / Change Controller / RFC 8126 designated-expert guidance, §14.3 references registries whose names don't line up with transport-19, and §14.4 needs the Private-Use range upper limit clarified. [[will-law|Will Law]] opened a four-PR cleanup batch July 17 — [PR #192](https://github.com/moq-wg/msf/pull/192) *update normative references + IANA registries* (closing the [issue #191](https://github.com/moq-wg/msf/issues/191) IANA tracker), [PR #193](https://github.com/moq-wg/msf/pull/193) catalog-object publishing guidelines, [PR #194](https://github.com/moq-wg/msf/pull/194) add a `data` reserved track role, [PR #195](https://github.com/moq-wg/msf/pull/195) event-timeline JSON-example fixes — the pre-WGLC registry hygiene ahead of Vienna. **Two of these merged 2026-07-28** — [#194](https://github.com/moq-wg/msf/pull/194) landing the new **`data` reserved track role** (+14/−13) and [#193](https://github.com/moq-wg/msf/pull/193) the updated **catalog-object publishing guidelines** (+8/−2) — the first MSF-repo merges since the July-14 init-data cluster.
