...
**Draft support**: **draft-18** (migrated 2026-08-30, ALPN-based version negotiation) — the whole stack cut **v0.14.0 "draft-18 rewrite"** tags on 2026-08-31: [[moqlivemock]] v0.14.0, [[warp-player]] v0.14.0 (draft-18-only), on top of the Go library [[moqtransport]] **v0.11.1** (v0.11.0 draft-18 rewrite Aug-30, v0.11.1 "qlog payload cap" Aug-31; **v0.12.0** "receive-side fixes for relays" Sep-1, base of the new `mlmrel` relay)
...
## moqtransport
- **GitHub**: [Eyevinn/moqtransport](https://github.com/Eyevinn/moqtransport) — Go. Latest: **v0.11.1 "qlog payload cap"** (Aug 31, 2026; v0.11.0 draft-18 rewrite Aug 30).
...
- **`mlmrel` — MoQ relay** ([#136](https://github.com/Eyevinn/moqlivemock/pull/136), Sep-1, 2026, +2913/−233): a MoQ relay with **fanout, a group cache, and FETCH relaying**, built on [[moqtransport]] v0.12.0. Gives the Eyevinn stack its own relay role alongside publisher/subscriber/interop-client; OPEN follow-ups cover `moqt://` subscriber URLs ([#134](https://github.com/Eyevinn/moqlivemock/issues/134)) and further relay work ([#135](https://github.com/Eyevinn/moqlivemock/issues/135)). Not yet in a tagged release (v0.14.0 stands).
...
- **`mlmrel` — the stack gains its own relay** (Sep-1, 2026, [#136](https://github.com/Eyevinn/moqlivemock/pull/136), +2913/−233): moqlivemock added a MoQ **relay** with fanout, group cache and FETCH relaying, built on [[moqtransport]] **v0.12.0** ("receive-side fixes for relays"). Previously publisher (`mlmpub`) + subscriber (`mlmsub`) + interop client (`mlmtest`), the Eyevinn stack now also has a relay role — useful for self-contained interop and cache/FETCH testing. Untagged (v0.14.0 stands); OPEN follow-ups: `moqt://` subscriber URLs ([#134](https://github.com/Eyevinn/moqlivemock/issues/134)), further relay work ([#135](https://github.com/Eyevinn/moqlivemock/issues/135)).
